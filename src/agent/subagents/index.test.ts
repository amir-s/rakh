...
describe("getSubagent", () => {
  ...
  it("returns the compact subagent for id=compact", () => {
    ...
    expect(sa?.tools).toContain("agent_project_memory_remove");
    expect(sa?.tools).toContain("agent_project_memory_edit");
    expect(sa?.systemPrompt).toContain("agent_project_memory_add");
    expect(sa?.systemPrompt).toContain("agent_project_memory_remove");
    expect(sa?.systemPrompt).toContain("agent_project_memory_edit");
  });
